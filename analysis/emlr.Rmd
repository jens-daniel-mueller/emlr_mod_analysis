...
path_version_data <- "/nfs/kryo/work/jenmueller/emlr_cant/model/v_XXX_9pre_vif20_m10_rank_12-08_tref_gamma/data/"
cant_inv_JDM <-
  read_csv(paste(path_version_data,
                 "cant_inv.csv",
                 sep = ""))
...
section_o <- map +
  scale_fill_manual(values = colorRampPalette(brewer.pal(11, "RdBu"))(13)[c(12,10,8,6,4,2)],
...
i_basin_AIP <- "Indian"
     ...
     ggsave("a.png", width = 5.4, height = 3.65)
